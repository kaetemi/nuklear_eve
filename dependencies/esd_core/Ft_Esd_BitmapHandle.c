...
// uint8_t Ft_Esd_BitmapHandleUse[FT_ESD_BITMAPHANDLE_NB] = { 0 };
// uint8_t Ft_Esd_ScratchHandle = 15;
#define FT_ESD_SCRATCHHANDLE ESD_CO_SCRATCH_HANDLE

// ft_bool_t Ft_Esd_BitmapHandleResized[FT_ESD_BITMAPHANDLE_NB] = { 0 };
// uint8_t Ft_Esd_BitmapHandlePage[FT_ESD_BITMAPHANDLE_NB] = { 0 };

// #define FT_ESD_FONTHANDLE_NB 16UL // First font handle
// #define FT_ESD_ROMFONT_NB 35UL
// uint8_t Ft_Esd_RomFontHandles[FT_ESD_ROMFONT_NB - FT_ESD_FONTHANDLE_NB] = { 0 };
