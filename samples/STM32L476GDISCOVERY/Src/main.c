...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, AUDIO_RST_Pin|GPIO_PIN_8|XL_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_2|M3V3_REG_ON_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : VLCD_Pin SEG22_Pin SEG14_Pin SEG9_Pin 
                           SEG13_Pin */
  GPIO_InitStruct.Pin = VLCD_Pin|SEG22_Pin|SEG14_Pin|SEG9_Pin 
                          |SEG13_Pin;
  ...
  /*Configure GPIO pins : PB2 M3V3_REG_ON_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_2|M3V3_REG_ON_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : PE8 XL_CS_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_8|XL_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
